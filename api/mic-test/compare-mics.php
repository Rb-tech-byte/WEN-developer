<?php
/**
 * GET /api/mic-test/compare-mics.php
 * Get microphones for comparison
 */
...
$ids = isset($_GET['ids']) ? explode(',', sanitize($_GET['ids'])) : [];

if (empty($ids)) {
    jsonResponse([
        'success' => false,
        'error' => 'Microphone IDs are required'
    ], 400);
}
...
$demo_mics = [
    1 => [
        ...
        'full_description' => 'The Shure SM7B is a legendary microphone that has been the go-to choice for professional broadcasters, podcasters, and voice-over artists for decades.',
    ...
    7 => [
        ...
        'full_description' => 'The Blue Ember is a compact, side-address condenser microphone.',
    ...
    9 => [
        ...
        'full_description' => 'The Lewitt MTP 550 DM is a compact dynamic handheld microphone.',
...
if (!empty($result)) {
    ...
    jsonResponse([
        'success' => false,
        'error' => 'No microphones found for comparison'
    ], 404);
}